...
A headless Vue 3 component library with 316 components. All components are headless (no built-in styles), fully accessible (WCAG 2.2 AAA), and use Vue 3 Composition API with `<script setup lang="ts">`.

## Features

- 316 headless Vue components
...
import { ref } from "vue";
import Button from "lily-vue-headless/components/Button.vue";
import TextInput from "lily-vue-headless/components/TextInput.vue";
import Alert from "lily-vue-headless/components/Alert.vue";
...
- [Vue Nuxt Examples](../lily-vue-nuxt-examples/) — Example app with simple styling
