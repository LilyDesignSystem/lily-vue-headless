<script setup lang="ts">
    ...
    //   value — number, default 50. Current numeric value; bindable with v-model.
    ...
    //
    // Syntax:
    //   <RangeInput label="Volume" v-model />
    //
    // Examples:
    //   <!-- Volume slider -->
    //   <RangeInput label="Volume" v-model min={0} max={100} />
    //
    //   <!-- Price range with step -->
    //   <RangeInput label="Price range" v-model={price} min={10} max={500} step={10} />
    //
    // Keyboard:
