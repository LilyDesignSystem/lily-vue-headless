<script setup lang="ts">
    ...
    // only when the open state is true, using defineModel() for two-way binding of
    ...
    //
    // Syntax:
    //   <Popover label="Info" v-model:open>{children}</Popover>
    //
    // Examples:
    //   <!-- Popover with toggle trigger -->
    //   <button onclick={() => showPopover = !showPopover}>Toggle info</button>
    //   <Popover label="Additional information" v-model:open={showPopover}>
