<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <FiveStarRatingPicker label="Rate this" v-model />
    //
    // Examples:
    //   <!-- Basic star rating with two-way binding -->
    //   <FiveStarRatingPicker label="Rate this product" v-model={rating} />
    //
    //   <!-- Disabled star rating -->
    //   <FiveStarRatingPicker label="Your rating" v-model disabled />
    //
    // Keyboard:
...
<template>
    ...
    <fieldset
        ...
        :disabled="disabled"
    >
                <label v-for="star in stars" :key="star">
                <input
                    type="radio"
                    :name="name"
                    :value="star"
