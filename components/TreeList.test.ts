...
import Subject from "./TreeList.vue";
...
describe("TreeList", () => {
  test("renders a tree", () => {
    render(Subject, {
      ...
      slots: {
        default:
          "<li role='treeitem' tabindex='-1'>Documents</li><li role='treeitem' tabindex='-1'>Photos</li>",
      },
    });
