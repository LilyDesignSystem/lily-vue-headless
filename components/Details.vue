<script setup lang="ts">
    ...
    //   default slot. Content revealed when expanded.
    ...
    //   <Details summary="Advanced options" v-model:open={showAdvanced}>
    ...
    //   - Uses defineModel() on open for two-way state synchronization
