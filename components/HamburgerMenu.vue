<script setup lang="ts">
    ...
    //   default slot. Navigation content rendered when the menu is open.
    //   ...restProps — additional HTML attributes spread onto the outer div wrapper.
    //
    // Syntax:
    //   <HamburgerMenu label="Main menu" v-model:open>{children}</HamburgerMenu>
    //
    // Examples:
    //   <!-- Basic hamburger menu with navigation links -->
    //   <HamburgerMenu label="Main menu" v-model:open>
    //     <nav>
    //       <ul>
    //         <li><a href="/">Home</a></li>
    ...
    //   <HamburgerMenu v-model:open={menuOpen}>
    //     <ul>
